          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                <strong>Prediction Markets</strong>  Decide <em className="italic">AI Agent</em> Funding
              </h1>
            </motion.div>
            ...
            >
              Futarchy governance for autonomous agents on Solana. Markets predict success, capital follows conviction.
            </motion.p>
